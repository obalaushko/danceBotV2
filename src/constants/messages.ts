...
export const MSG = {
    welcome: {
        ...
        admin: (user: ITGUser) =>
            `Привіт, ${user.first_name}!\nВи можете додавати нових учнів, слідкувати за відвідувальністю, оновлювати їм абонементи та персональні дані, видаляти учнів які були довго відстуні на занятті.`,
    ...
    buttons: {
        admin: {
            ...
            updateUser: '🔄 Оновити дані учнів',
            markUser: '✅ Відмітити учнів',
            updateSubscription: '🎫 Оновити абонементи',
            updatePaymentDetails: '💳 Оновити реквізити',
