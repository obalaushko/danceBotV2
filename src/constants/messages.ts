...
export const MSG = {
    ...
    about: {
        general: 'Привіт, я тут, щоб допомогти вам як асистент. Мої завдання включають в себе ведення обліку відвідуваності учнів та контроль абонементів. А ще я дозволяю учням контролювати свої абонементи та отримувати сповіщення про їх закінчення.',
        admin: '<i>Admin only</i>\n\nЩоб переглянути всю документацію по боту, відкрийте веб-застосунок.',
        user: 'Привіт, я тут, щоб допомогти вам як асистент. Мої завдання включають в себе ведення обліку відвідуваності учнів та контроль абонементів. А ще я дозволяю учням контролювати свої абонементи та отримувати сповіщення про їх закінчення.\n\nЩоб дізнатися більше про те як працює бот або переглянути історію свого абонементу, відкрийте веб-застосунок',
    },
