...
export const MSG = {
    ...
    payments: {
        static: 'Реквізити для оплати:\n🏦 Monobank <i>(Антонюк Дарія Сергіївна)</i>\n💳 <code>4441 1110 6321 1654</code>\nАбонемент на 8 занять: <b>750 грн</b>\nОдне заняття: <b>120 грн</b>',
    ...
    user: {
        ...
        notification: {
            ...
            paymentRemaider:
                '🔔 Ваш абонемент закінчився. Щоб продовжити використання, оплатіть новий.',
        },
        freeze: {
